...
// 每日支出汇总
func DailyExpenseTotalHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DailyExpenseTotalReq
		if err := httpx.Parse(r, &req); err != nil {
			respx.ErrorCtx(r.Context(), w, errorx.WrapBadRequest("请求参数解析失败", err))
			return
		}

		l := expense.NewDailyExpenseTotalLogic(r.Context(), svcCtx)
		resp, err := l.DailyExpenseTotal(&req)
		if err != nil {
