...
// 分类支出占比
func ExpenseStatsCategoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := expense.NewExpenseStatsCategoryLogic(r.Context(), svcCtx)
		resp, err := l.ExpenseStatsCategory(&req)
		if err != nil {
