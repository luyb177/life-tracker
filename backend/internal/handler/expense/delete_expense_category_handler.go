...
// 删除自定义分类
func DeleteExpenseCategoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteExpenseCategoryReq
		if err := httpx.Parse(r, &req); err != nil {
			respx.ErrorCtx(r.Context(), w, errorx.WrapBadRequest("请求参数解析失败", err))
			return
		}

		l := expense.NewDeleteExpenseCategoryLogic(r.Context(), svcCtx)
		resp, err := l.DeleteExpenseCategory(&req)
		if err != nil {
